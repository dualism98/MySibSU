...
export default function EventsScreen(props){
    ...
    const services = (locale) => {return [{name: locale['institutes'], path: 'Institutes', image: <View style={{ height: 55, width: 55, alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end', borderRadius: 5, backgroundColor: mode === 'light' ? 'rgba(0,0,0, 0.4)' : 'lightgray'}}><FontAwesome5 name="university" size={40} color={theme.blockColor} /></View>}, 
                    ...
                    {name: locale['vacancies'], path: 'Vacancies', image: <View style={{ height: 55, width: 55, alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end', borderRadius: 5, backgroundColor: mode === 'light' ? 'rgba(0,0,0, 0.4)' : 'lightgray'}}><MaterialIcons name="engineering" size={40} color={theme.blockColor} /></View>},
                    {name: locale['feedback'], path: 'Poll', image: <View style={{ height: 55, width: 55, alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end', borderRadius: 5, backgroundColor: 'rgba(76, 174, 50, 0.6)'}}>
                    ...
                    {name: "FAQ", path: 'FAQ', image: <View style={{ height: 55, width: 55, alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end', borderRadius: 5, backgroundColor: 'rgba(0, 108, 181, 0.6)'}}><Text style={{fontFamily: 'roboto', color: theme.blockColor, fontWeight: 'bold', fontSize: 40}}>?</Text></View>},
                    {name: locale['library'], path: 'LibrarySearch', image: <View style={{ height: 55, width: 55, alignItems: 'center', justifyContent: 'center', alignSelf: 'flex-end', borderRadius: 5, backgroundColor: mode === 'light' ? 'rgba(0,0,0, 0.4)' : 'lightgray'}}><Ionicons name="library-outline" size={40} color={theme.blockColor} /></View>}] }
