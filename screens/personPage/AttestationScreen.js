                ...
                {attestation.map(item => {
                    return(
                        <View style={{width: w * 0.9, borderRadius: 15, backgroundColor: theme.blockColor, elevation: 5, alignSelf: 'center', marginTop: 15, padding: 10}}>
                            <Text style={{fontFamily: 'roboto', fontSize: 15, color: theme.labelColor, borderBottomWidth: 1, borderColor: '#CCC'}}>{item.name} <Text style={{color: 'gray'}}>({item.type})</Text></Text>
                            <View style={{flexDirection: 'row', justifyContent: 'space-evenly'}}>
                                <View style={{flexDirection: 'column', width: w * 0.2, alignItems: 'center'}}>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor}}>1 атт.</Text>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor, marginTop: 3}}>{item.att1}</Text>
                                </View>
                                <View style={{flexDirection: 'column', width: w * 0.2, alignItems: 'center'}}>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor}}>2 атт.</Text>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor, marginTop: 3}}>{item.att2}</Text>
                                </View>
                                <View style={{flexDirection: 'column', width: w * 0.2, alignItems: 'center'}}>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor}}>3 атт.</Text>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor, marginTop: 3}}>{item.att3}</Text>
                                </View>
                                <View style={{flexDirection: 'column', width: w * 0.2, alignItems: 'center'}}>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor}}>Итог</Text>
                                    <Text style={{fontFamily: 'roboto', color: theme.labelColor, marginTop: 3}}>{item.att}</Text>
                                </View>
                            </View>
                        </View>
                    )
